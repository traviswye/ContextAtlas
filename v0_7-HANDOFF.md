...
| C14 | Cobra contamination drift root-cause investigation — carry forward or drop? | EXPLICITLY DROP. F3 cycle-emergent finding at ref-doc §9 captures broader observation | **EXPLICITLY DROPPED** at v0.6 scope-doc Phase 1+2 transition (commit `a8d01eb`); F3 cycle-emergent at [Phase-10 ref-doc §9 at benchmarks-repo](https://github.com/traviswye/ContextAtlas-benchmarks/blob/main/research/phase-10-v0.6-reference-run.md) captures broader observation; v0.6 ship at [main-repo `[ship-SHA]`](https://github.com/traviswye/ContextAtlas/commit/[ship-SHA]). **Distinguish-from-absorbed**: DROPPED as scope, NOT absorbed via close-as-superseded or close-as-substantively-validated routes. |
